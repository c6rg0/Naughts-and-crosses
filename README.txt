...
To play, run the "naughts_and_crosses.py" script in the scripts folder.


Read this if you are getting errors running it:
...
$ export PYTHONPATH=. 
into the console (if you're in an ide, you will have to do this in a seperate cli, or built in console idk).
Yay, you fixed it.
